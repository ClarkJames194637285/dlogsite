...
if (isset($_POST['login'])) {
    ...
    if ($mysqli->connect_error) {
        error_log($mysqli->connect_error, 3, "./log/test.log");
        exit;
    }
    if ($_POST['user_name'] != "") {
            ...
            <div class="login-form">
                ...
                <div class="form-input">
                    <form id="form" class="login" action="<?php echo base_url();?>" method="post">
                        ...
                        lang="ja" placeholder="<?=$this->lang->line('username');?>" name="user_name"
                        <?php
                        if (isset($get_data)) {
                        ...
                        <input type="password" class="input-form langCng" lang="ja" 
                        ...
                        if (isset($get_data)) {
                            foreach ($select_arr as $key => $val) {
                                if (floatval($get_data['TimeZone']) == floatval($val)) {
                                    echo '<option class ="langCng" lang="ja" value="' . $val . '" selected>';
                                    echo $key . '</option>';
                                } else {
                            ...
                            <option class ="langCng" lang="ja" value="9" selected><?=$this->lang->line('timezone');?></option>
                            <!-- <option class ="langCng" lang="ja" value="9_ja" selected>タイムゾーン +9（日本）</option> -->
                            <!-- <option class ="langCng "lang="en" value="9_en" >Timezone +9（Japan）</option> -->
                        ...
                        <label class="container">
                            <p class="langCng" lang="ja"><?=$this->lang->line('remember_me');?></p>
                        ...
                        <button id = "login" name="login" class="login-btn langCng" lang="ja" type="submit"
                ...
                <div class="forget-pass">
                    <a href="<?php echo base_url();?>Passforget" class ="langCng" lang="ja"><?=$this->lang->line('forgot_password');?></a>
                    <!-- <a href="pass-forget.php" class ="langCng" lang="en">forget password?</a> -->
                </div>
                <a href="<?php echo base_url();?>register" class="register-btn langCng" lang="ja"><?=$this->lang->line('register');?></a>
