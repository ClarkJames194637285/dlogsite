...
$userlist = $dlogdb->dbSelectUsers($dbpdo,$order);
...
?>
    ...
    <script type="text/javascript" src="<?php echo base_url()?>assets/sitejs/admin_user_delete.js"></script>
</head>
...
<body id="pg_index" class="pg_index user_setting">
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            ?>
                ...
                <div class="operation-block flexlyr" style="flex-direction: row-reverse;">
                    <!-- <a href="userdelete/edit?M=Add" class="add-btn"></a> -->
    ...
    if (isset($_GET['M']) && $_GET['M'] == 'Add') {
        ...
        if ($ins_flg) {
            $alert .= "location.href='./userdelete';</script>";
        } else {
            $alert .= "location.href='./userdelete/edit?M=Add';</script>";
        }
        echo $alert;
    }
